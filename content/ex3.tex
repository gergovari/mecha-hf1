...
\begin{equation}
    ...
    \end{bmatrix}
\end{equation}
$\mathbf{C}_{de} = \begin{bmatrix} 0 & 1 \end{bmatrix}$, $\mathbf{D}_{de} = 0$.
...
\begin{equation}
    ...
    \end{bmatrix}
\end{equation}
Kimeneti mátrixok a hátratartó esetre ($\mathbf{C}_{dh} = \mathbf{C} \mathbf{A}_{dh}$, $\mathbf{D}_{dh} = \mathbf{D} + \mathbf{C} \mathbf{B}_{dh}$):
\begin{equation}
    \mathbf{C}_{dh} = \begin{bmatrix} 0.8467 & 0.2681 \end{bmatrix}, \quad \mathbf{D}_{dh} = 17.8265
\end{equation}
