...
\end{align}
Ebből a klasszikus struktúragráf felépíthető az elektromos hálózat és a mechanikai oldal összekapcsolásával egy ideális váltó (motorállandó) és hajtómű váltó segítségével.
...
Z_1(s) = R + s L
\end{equation}
A mechanikai forgórész impedanciája (mobilitási analógia alapján, ahol az feszültség-változó a nyomaték és az áram-változó a szögsebesség):
\begin{equation}
...
Az átviteli függvény nevezőjének gyökei (pólusok) határozzák meg a rendszer időállandóit ($T_i = -1/p_i$). A kiszámolt gyökök alapján az időállandók:
\begin{equation}
