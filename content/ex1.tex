...
\begin{figure}[H]
    ...
    \resizebox{0.7\linewidth}{!}{
        \begin{tikzpicture}[>=stealth, thick,
            ...
            % Angular velocity source (szögsebesség forrás)
            \draw[fill=white] (0,1.5) circle (0.4) node[left=0.5cm] {$\Omega'_{be} = \frac{U_{be}}{k_m N}$};
            \draw[<-, thick] (-0.35, 1.2) to[bend left=30] (-0.35, 1.8);
            \draw (0,1.9) -- (0,3) -- (1.5,3);
            \draw (0,1.1) -- (0,0) -- (1.5,0);

            % Z12
            \node[block] (Z12) at (2.5, 3) {$Z_{12}$};
            \draw (1.5,3) -- (Z12.west);
            \draw (Z12.east) -- (5,3);
            \draw (1.5,0) -- (5,0);

            % Z22
            \node[block] (Z22) at (5, 1.5) {$Z_{22}$};
            \draw (5,3) -- (Z22.north);
            \draw (Z22.south) -- (5,0);
            \fill (5,3) circle (2pt); \fill (5,0) circle (2pt);

            % Zt
            \node[block] (Zt) at (8, 1.5) {$Z_{t}$};
            \draw (5,3) -- (8,3) -- (Zt.north);
            \draw (5,0) -- (8,0) -- (Zt.south);
            \fill (8,3) circle (2pt); \fill (8,0) circle (2pt);

            % Mt Effort Source
            \draw (8,3) -- (10.5,3);
            \draw (8,0) -- (10.5,0);
            \draw[fill=white] (10.5,1.5) circle (0.4) node[right=0.5cm] {$-M_t$};
            \draw[<-] (10.5,1.9) -- (10.5,1.1);
            \draw (10.5,1.9) -- (10.5,3);
            \draw (10.5,1.1) -- (10.5,0);

        \end{tikzpicture}
    }
    \caption{Az egyesített, négypólusoktól mentes redukált impedanciahálózat}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{res/imgs/fig_HajtaslancUgras1V.png}
    \caption{A $W_1(s)$ átviteli függvény ugrásválasza 1V-os feszültségugrás mellett}
\end{figure}
