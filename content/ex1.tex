...
\begin{figure}[H]
    ...
    \resizebox{0.7\linewidth}{!}{
        \begin{tikzpicture}[>=stealth, thick,
            ...
            % Voltage source
            \draw[fill=white] (0,1.5) circle (0.4) node[left=0.5cm] {$U'_{be} = U_{be} k_m N$};
            \draw[->] (0,1.9) -- (0,1.1);
